...
export default function PixelSnow({
  ...
  return <div ref={containerRef} className={`absolute pointer-events-none inset-0 -z-10 w-full h-full transform-gpu will-change-transform backface-hidden ${className}`} style={style} />;
}
